...
const ProducerAPI = require('./API/Router/producer.router')
const NoteAPI = require('./API/Router/note.router')

const ProductAdmin = require('./API/Router/admin/product.router')
const ProducerAdmin = require('./API/Router/admin/producer.router')
...
mongoose.connect("mongodb+srv://minhhieu:123@cluster0.9kabc.mongodb.net/SmartPhone?retryWrites=true&w=majority", {
...
app.use('/api/Producer', ProducerAPI)

app.use('/api/admin/Product', ProductAdmin)
app.use('/api/admin/Producer', ProducerAdmin)
