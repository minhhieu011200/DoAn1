...
function CreateSale(props) {
    ...
    const handleCreate = () => {
        ...
        let productSale = products.filter(product => {
            return product.check === true
        })

        addCoupon(productSale);
    }
    const addCoupon = async (productSale) => {
        const body = {
        ...
        const response = await saleAPI.postCreate(body)
                        ...
                        <div className="card">
                            <div className="card-body">
                                ...
                                <form onSubmit={handleSubmit(handleCreate)}>
                                    ...
                                    <button type="submit" className="btn btn-primary mt-3">Create Sale</button>
                                </form>
                            </div>
                        </div>
                    </div>
